...
public class BasketSummaryPage extends StrongerDriver {
    private static final By BANK_NAME_TEXT = By.xpath("//*[@class='modal_bank_details_lfXb9']//div[1]//span[2]");
    private static final By PAYMENT_METHOD_TEXT = By.xpath("//*[@class='modal_bank_details_lfXb9']//div[2]//span[2]");
